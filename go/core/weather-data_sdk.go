...
func (sdk *WeatherDataSDK) OptionsMap() map[string]any {
...
func (sdk *WeatherDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WeatherDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WeatherDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WeatherDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WeatherDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WeatherDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WeatherDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WeatherDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
