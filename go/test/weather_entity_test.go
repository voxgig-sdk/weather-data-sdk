...
func TestWeatherEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set WEATHERDATA_TEST_WEATHER_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func weatherBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WEATHERDATA_TEST_WEATHER_ENTID")
	...
	idmapResolved := core.ToMapAny(env["WEATHERDATA_TEST_WEATHER_ENTID"])
