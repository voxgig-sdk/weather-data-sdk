...
const testSeed = `map[string]any{"entity": map[string]any{"history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "weather": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
