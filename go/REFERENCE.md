# WeatherData Golang SDK Reference

Complete API reference for the WeatherData Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *WeatherDataSDK`
...
#### `History(data map[string]any) WeatherDataEntity`

Create a new `History` entity instance. Pass `nil` for no initial data.

#### `Weather(data map[string]any) WeatherDataEntity`
