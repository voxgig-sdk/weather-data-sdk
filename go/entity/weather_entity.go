...
func NewWeatherEntity(client *core.WeatherDataSDK, entopts map[string]any) *WeatherEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WeatherEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
