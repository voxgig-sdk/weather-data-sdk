// Command WeatherData-mcp is an MCP server exposing the WeatherData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WeatherData_list  — list records of an entity
//	WeatherData_load  — load a single record of an entity
//
