...
type Args struct {
	Entity string         `json:"entity" jsonschema:"history | weather"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WeatherDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data_list",
		Description: "List records from WeatherData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data_load",
		Description: "Load a single record from WeatherData. " +
...
func runOp(client *sdk.WeatherDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeatherDataSDK, name string) (sdk.WeatherDataEntity, error) {
