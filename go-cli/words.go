...
func registerSDKWords(r *eng.Registry, client *sdk.WeatherDataSDK) {
...
func runOp(client *sdk.WeatherDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
