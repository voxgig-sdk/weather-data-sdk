...
Results: Successful response with historical weather data.
...
Results: Successful response with weather data.
...
| --- | --- | --- | --- |
| History | `list` | `GET /history` | Required |
| Weather | `list` | `GET /weather` | Required |

## Connect to the API

- Production server for current and forecast weather data: `https://api.weatherxu.com/v1`
- Production server for historical weather data: `https://historical.weatherxu.com/v1`

The default credential is sent in the `X-API-KEY` header.

API key for authentication. Sign up at https://weatherxu.com to get your API key.
...
- `weather-data_list`: List records for an entity. Supported entities: `history`, `weather`.
- `weather-data_load`: Load one record for an entity. No active entity supports this operation.
