...
function runner.env_override(m)
  local live = runner.getenv("WEATHERDATA_TEST_LIVE")
  local override = runner.getenv("WEATHERDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WEATHERDATA_TEST_EXPLAIN")
