...
(0, node_test_1.describe)('WeatherDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WeatherDataSDK({
    ...
    (0, node_test_1.test)('direct-list-weather', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-weather', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.WEATHER_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'WEATHER_DATA_TEST_WEATHER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.WeatherDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.WEATHER_DATA_APIKEY,
        }));
        let idmap = env['WEATHER_DATA_TEST_WEATHER_ENTID'];
    ...
    const client = new __1.WeatherDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WeatherDirect.test.js.map