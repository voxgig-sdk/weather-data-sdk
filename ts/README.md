# WeatherData TypeScript SDK



The TypeScript SDK for the WeatherData API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.History()` — each with a small set of operations (`list`)
...
- Releases: [https://github.com/voxgig-sdk/weather-data-sdk/releases](https://github.com/voxgig-sdk/weather-data-sdk/releases)
...
```ts
const client = new WeatherDataSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `WeatherDataSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `WeatherDataSDK.test(testopts?, sdkopts?)` | `WeatherDataSDK` | Create a test-mode client. |
...
| `client` | `client(): WeatherDataSDK` | Return the parent SDK client. |
...
```ts
const weathers = await client.Weather().list({ lat: 1, lon: 1 })
```
...
weather-data/
├── src/
│   ├── WeatherDataSDK.ts        # Main SDK class
