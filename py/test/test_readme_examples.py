# WeatherData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeatherDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeatherDataSDK(...) and WeatherDataSDK.test(...) become
#      WeatherDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weatherdata_sdk"
_SDK_CLASS = "WeatherDataSDK"
