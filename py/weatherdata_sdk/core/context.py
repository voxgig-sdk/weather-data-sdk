...
from weatherdata_sdk.core.control import WeatherDataControl
...
from weatherdata_sdk.core.helpers import get_ctx_prop, to_map
...
class WeatherDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, WeatherDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WeatherDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WeatherDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WeatherDataError(code, msg, self)
