...
from weatherdata_sdk.utility import register

# Load features
from weatherdata_sdk.feature.base_feature import WeatherDataBaseFeature
from weatherdata_sdk.features import _has_feature, _make_feature
...
class WeatherDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WeatherDataUtility()
        self._utility = utility

        from weatherdata_sdk.config import shared_config
    ...
    def get_utility(self):
        return WeatherDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeatherDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def History(self, data=None) -> "HistoryEntity":
        ...
        from weatherdata_sdk.entity.history_entity import HistoryEntity
    ...
    def Weather(self, data=None) -> "WeatherEntity":
        ...
        from weatherdata_sdk.entity.weather_entity import WeatherEntity
