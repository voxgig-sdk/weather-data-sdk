# WeatherData Python SDK



The Python SDK for the WeatherData API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.History()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/weather-data-sdk/releases)) or
...
```
py/
├── weatherdata_sdk.py         -- Main SDK module
