...
class WeatherDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeatherDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WeatherDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WeatherDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
