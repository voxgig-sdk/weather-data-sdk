...
class WeatherDataCacheFeature extends WeatherDataBaseFeature
{
    ...
    private function _through(WeatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
