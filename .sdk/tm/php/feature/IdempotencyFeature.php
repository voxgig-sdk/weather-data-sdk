...
// WeatherData SDK idempotency feature
...
class WeatherDataIdempotencyFeature extends WeatherDataBaseFeature
{
    ...
    private function _mutating(WeatherDataContext $ctx): bool
    {
