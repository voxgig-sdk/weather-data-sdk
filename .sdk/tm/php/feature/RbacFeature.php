...
class WeatherDataRbacFeature extends WeatherDataBaseFeature
{
    ...
    private function _required(WeatherDataContext $ctx): ?string
    {
    ...
    private function _reject(WeatherDataContext $ctx, string $required): void
    {
    ...
    private function _track(WeatherDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
