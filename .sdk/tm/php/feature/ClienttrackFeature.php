...
// WeatherData SDK clienttrack feature
...
class WeatherDataClienttrackFeature extends WeatherDataBaseFeature
{
    ...
    public function PostConstruct(WeatherDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeatherData-SDK';
