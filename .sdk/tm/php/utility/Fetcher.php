...
// WeatherData SDK utility: fetcher
...
class WeatherDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeatherDataSDK/1.0)';
    ...
    public static function call(WeatherDataContext $ctx, string $fullurl, array $fetchdef): array
    {
