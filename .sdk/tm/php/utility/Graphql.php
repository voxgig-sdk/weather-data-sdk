...
// WeatherData SDK utility: graphql
//
...
class WeatherDataGraphql
{
    ...
    // equivalent.
    public static function body(WeatherDataContext $ctx): mixed
    {
    ...
    public static function errors(WeatherDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
