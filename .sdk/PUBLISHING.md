...
|---|---|---|
| `ts/` | @voxgig-sdk/weather-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/weather-data-sdk \
      --repository voxgig-sdk/weather-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/weather-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/weather-data-sdk --id=<id>` removes it.
