...
class HistoryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEATHERDATA_TEST_HISTORY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function history_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEATHERDATA_TEST_HISTORY_ENTID");
