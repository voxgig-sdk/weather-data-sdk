...
// WeatherData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WeatherDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WeatherDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(WeatherDataOmni::structfix($val, Struct::undef()))) {
