...
// WeatherData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeatherDataSDK::test)
...
{
    private const SDK_CLASS = 'WeatherDataSDK';
    ...
    private const SDK_BASE = 'weatherdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../weatherdata_sdk.php';
