...
class WeatherDataTestRunner
{
    ...
    {
        $live = self::getenv('WEATHER_DATA_TEST_LIVE');
        $override = self::getenv('WEATHER_DATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WEATHER_DATA_TEST_EXPLAIN');
...
class_alias('WeatherDataTestRunner', 'Runner');
class_alias('WeatherDataHelpers', 'Helpers');
