...
// WeatherData SDK telemetry feature
...
class WeatherDataTelemetryFeature extends WeatherDataBaseFeature
{
    ...
    private function _close(WeatherDataContext $ctx, bool $ok): void
    {
