...
// WeatherData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WeatherDataTestFeature extends WeatherDataBaseFeature
{
    ...
    public function init(WeatherDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WeatherDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WeatherDataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WeatherDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WeatherDataContext $ctx, $op, $args): array
    {
