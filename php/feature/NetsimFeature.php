...
// WeatherData SDK netsim feature
...
class WeatherDataNetsimFeature extends WeatherDataBaseFeature
{
    ...
    private function _simulate(WeatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeatherDataContext $ctx, array $applied): void
    {
        $client = $this->client;
