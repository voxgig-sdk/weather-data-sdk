...
// WeatherData SDK metrics feature
...
class WeatherDataMetricsFeature extends WeatherDataBaseFeature
{
    ...
    private function _record(WeatherDataContext $ctx, bool $ok): void
    {
