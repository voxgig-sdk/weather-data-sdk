...
// WeatherData SDK streaming feature
...
class WeatherDataStreamingFeature extends WeatherDataBaseFeature
{
    ...
    private function _iterate(WeatherDataResult $result): \Generator
    {
    ...
    private function _streamable(WeatherDataContext $ctx): bool
    {
