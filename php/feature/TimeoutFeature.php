...
// WeatherData SDK timeout feature
...
class WeatherDataTimeoutFeature extends WeatherDataBaseFeature
{
    ...
    private function _with_timeout(WeatherDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeatherDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
