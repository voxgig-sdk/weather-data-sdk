...
class WeatherDataProxyFeature extends WeatherDataBaseFeature
{
    ...
    public function init(WeatherDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
