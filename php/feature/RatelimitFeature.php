...
// WeatherData SDK ratelimit feature
...
class WeatherDataRatelimitFeature extends WeatherDataBaseFeature
{
    ...
    private function _acquire(WeatherDataContext $ctx): void
    {
    ...
    private function _track(WeatherDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
