...
The PHP SDK for the WeatherData API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $history));
```
...
```
php/
├── weatherdata_sdk.php          -- Main SDK class
...
The main class (`weatherdata_sdk.php`) exports the SDK class
