...
// WeatherData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WeatherDataMakeRequest
{
    public static function call(WeatherDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WeatherDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WeatherDataResponse($fetched);
        } else {
