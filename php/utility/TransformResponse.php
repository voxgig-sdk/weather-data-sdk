...
// WeatherData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class WeatherDataTransformResponse
{
    public static function call(WeatherDataContext $ctx): mixed
    {
        ...
        $transform = WeatherDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
