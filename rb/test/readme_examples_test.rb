...
#      offline in seeded test mode (WeatherDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WeatherData_sdk.rb")
  SDK_CLASS = "WeatherDataSDK"
