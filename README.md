...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/weather-data` | `npm install @voxgig-sdk/weather-data` |
| Python | `voxgig-sdk-weather-data` | `pip install voxgig-sdk-weather-data` |
| PHP | `voxgig-sdk/weather-data` | `composer require voxgig-sdk/weather-data` |
| Golang | `github.com/voxgig-sdk/weather-data-sdk/go` | `go get github.com/voxgig-sdk/weather-data-sdk/go` |
| Ruby | `voxgig-sdk-weather-data` | `gem install voxgig-sdk-weather-data` |
| Lua | `voxgig-sdk-weather-data` | `luarocks install voxgig-sdk-weather-data` |
